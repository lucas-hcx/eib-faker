...
import com.lucashcx.app.models.ChangeJobEIBRow;

public class ChangeJobEIB implements EIBable {
  public static final String sheetName = "Change Job";
  ...
  public static final String inputfilePath = "Change_Job.xlsx";
  public static final String outputfilePath = "output - " + inputfilePath;

  public Map<String, Object> getEIBRow() {
    return (new ChangeJobEIBRow()).getFakeValues();
  }
